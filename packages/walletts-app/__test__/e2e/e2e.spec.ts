...
describe("main window", function spec() {
  ...
  it.skip('should navigate to Counter by "to Counter" link', async () => {
    const { client } = app;
  ...
  it.skip("shouldn't change if even and if odd button clicked", async () => {
    const { client } = app;
  ...
  it.skip("should navigate to home using back button", async () => {
    const { client } = app;
