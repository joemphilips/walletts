declare module 'blockchain.info' {
    ...
    export function usingNetwork(network: number): blockexplorer;
    ...
    export interface blockexplorer {
      ...
      getMultiAddress: (addresses: string[],
                        options?: AddressOptions) => Promise<Address[]>;
      getUnspentOutputs: (address: string,
                          options?: UTXOOptions) => Promise<UnspentOutput[]>;
